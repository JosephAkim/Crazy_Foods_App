package com.kim.crazyfoodsapp.fragment.bottomSheet
...
import com.kim.crazyfoodsapp.databinding.FragmentMealBottomSheetBinding
...
class MealBottomSheetFragment : BottomSheetDialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        onButtonSheetDialogClick()
    }

    private fun onButtonSheetDialogClick() {
